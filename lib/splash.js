...
export default function splash({ name, org, logo, active, total, channels, iframe }){
  let div = dom('.splash',
    ...
    dom('p', 'Code of conduct: <a href="https://docs.google.com/document/d/1WcAjNkJ8QzuvivK3XfpL9FQAncDLrsYNw3zQ-4FdAkw/edit?usp=sharing">https://docs.google.com/document/d/1WcAjNkJ8QzuvivK3XfpL9FQAncDLrsYNw3zQ-4FdAkw/edit?usp=sharing<a>'),
    dom('p',
      'Join ', dom('b', name),
