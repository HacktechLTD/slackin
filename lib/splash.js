...
export default function splash({ name, org, logo, active, total, channels, iframe }){
  let div = dom('.splash',
    ...
    dom('p', 'By requesting an invite to Join Techfugees on Slack, I agree to observe Techfugees’ <a href="https://docs.google.com/document/d/1WcAjNkJ8QzuvivK3XfpL9FQAncDLrsYNw3zQ-4FdAkw/edit?usp=sharing">Code of Conduct<a>'),
    dom('p',
      'Join ', dom('b', name),
